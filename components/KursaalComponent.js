  ...
  return (
    <>
      ...
      <div className="w-full flex justify-center items-center mt-8">
        <button className="bg-gray-300 hover:bg-gray-400 text-gray-800 font-bold py-0 px-2 rounded-l">
          Prev
        </button>
        <button className="bg-gray-300 hover:bg-gray-400 text-gray-800 font-bold py-0 px-2 rounded-r">
          Next
        </button>
      </div>
    </>
